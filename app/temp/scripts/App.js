...
var _MineSweeperBoard = __webpack_require__(8);

var _MineSweeperBoard2 = _interopRequireDefault(_MineSweeperBoard);
...
var minesweeper = new _MineSweeperBoard2.default();
                ...
                new Waypoint({
                    ...
                    handler: function handler(direction) {
                        if (direction == 'down') {
                            ...
                            (0, _jquery2.default)(targetElm).addClass('is-current-link');
                        }
                    },
                    offset: "18%"
                });
...
var _Array2D = __webpack_require__(9);
...
var MineSweeperBoard = function () {
    ...
    _createClass(MineSweeperBoard, [{
        ...
        value: function startGame() {
            this.minesPosition = new _Array2D2.default(this.gridSize[0], this.gridSize[1]);
        ...
        value: function countSurroundingMines() {
...
var Array2D = function () {
  function Array2D(xSize, ySize) {
    ...
    for (var i = 0; i < this.lengt; i++) {
      this.innerArray[i] = this.initialValue;
    }
  }
